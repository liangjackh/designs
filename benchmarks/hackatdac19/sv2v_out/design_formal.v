...
module issue_read_operands (
	...
	endgenerate
	assign operand_a_regfile = (ariane_pkg_is_rs1_fpr(issue_instr_i[290-:7]) ? (ariane_pkg_FLEN > 0 ? fprdata[0+:(ariane_pkg_FLEN > 0 ? ariane_pkg_FLEN : 1)] : 64'b0) : rdata[0+:64]);
	assign operand_b_regfile = (ariane_pkg_is_rs2_fpr(issue_instr_i[290-:7]) ? (ariane_pkg_FLEN > 0 ? fprdata[(ariane_pkg_FLEN > 0 ? ariane_pkg_FLEN : 1)+:(ariane_pkg_FLEN > 0 ? ariane_pkg_FLEN : 1)] : 64'b0) : rdata[64+:64]);
	assign operand_c_regfile = (ariane_pkg_FLEN > 0 ? fprdata[2 * (ariane_pkg_FLEN > 0 ? ariane_pkg_FLEN : 1)+:(ariane_pkg_FLEN > 0 ? ariane_pkg_FLEN : 1)] : 64'b0);
	always @(posedge clk_i or negedge rst_ni)
		if (~rst_ni) begin
			operand_a_q <= {64 {1'd0}};
			operand_b_q <= {64 {1'd0}};
		...
		if (1) begin : dut
			...
			if (1) begin : axi_node_intf_wrap_i
				...
				for (_gv_i_10 = 0; _gv_i_10 < NB_MANAGER; _gv_i_10 = _gv_i_10 + 1) begin : genblk1
					...
					assign formal_top.primary[i + _mbase_master].aw_user = s_master_aw_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)];
					...
					assign formal_top.primary[i + _mbase_master].ar_user = s_master_ar_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)];
					...
					assign formal_top.primary[i + _mbase_master].w_user = s_master_w_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)];
					...
					assign s_master_b_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)] = formal_top.primary[i + _mbase_master].b_user;
					...
					assign s_master_r_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)] = formal_top.primary[i + _mbase_master].r_user;
				...
				for (_gv_j_4 = 0; _gv_j_4 < NB_SUBORDINATE; _gv_j_4 = _gv_j_4 + 1) begin : genblk2
					...
					assign s_slave_aw_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)] = formal_top.subordinate[j + _mbase_slave].aw_user;
					...
					assign s_slave_ar_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)] = formal_top.subordinate[j + _mbase_slave].ar_user;
					...
					assign s_slave_w_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)] = formal_top.subordinate[j + _mbase_slave].w_user;
					...
					assign formal_top.subordinate[j + _mbase_slave].b_user = s_slave_b_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)];
					...
					assign formal_top.subordinate[j + _mbase_slave].r_user = s_slave_r_user[0+:(AXI_USER_WIDTH > 0 ? AXI_USER_WIDTH : 1)];
